...
<body>
	<div class="kotak_login">
		<p clss="tulisan_login" align="cenet">Silahkan Masukkan<br/>
			                    Username Dan Password Anda Dengan Benar</p>
...
if (isset($_POST['btnlogin'])) {
	...
	$sql      = $koneksi->query("SELECT * FROM admin WHERE username = '$username'");
